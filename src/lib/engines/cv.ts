 ...
 * Heuristics first (works with zero AI); AI refinement can layer on top later.
 */
...
/**
 * Map each extracted requirement to evidence in the master profile, honestly.
 * DEVELOPING skills are labelled developing; never upgraded to expert.
 */
